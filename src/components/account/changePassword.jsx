...
export const Changepassword = () => {
  ...
  const validation = useCallback(() => {
    ...
    formData.oldPassword && formData.newPassword && passwordCheck
      ? setDisabled(false)
      : setDisabled(true);
  }, [formData]);
  ...
  useEffect(() => {
    ...
    if (account?.errorOldPass) {
      setEmaillPass(false);
      if (
        account?.errorOldPass?.message === "Incorrect username or password."
      ) {
  ...
  useEffect(() => {
    ...
    return <div className="changePasswordWrapper">
