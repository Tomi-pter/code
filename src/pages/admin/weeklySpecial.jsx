...
export default (props) => {
  ...
  const categoryMap = useSelector((state) =>
    state.products.categories.reduce((acc, category) => {
  ...
  const handleProductSubmit = (event) => {
    if (
      !weeklySpecial.id ||
      !weeklySpecial.name ||
      !weeklySpecial.category ||
      !weeklySpecial.oldPrice ||
      !weeklySpecial.newPrice
    ) {
          ...
          >
            <Modal.Body>
              <h2 className="sub-title">
                {isEdit ? "Update" : "Add"} Weekly Special Product
              </h2>
              <div className="row">
                <div
                  className="col"
                          ...
                          searchResults.map((result) => {
                            return (
                              <li
                                key={result.obj.id}
                                onClick={() =>
                                  selectProductFromDropdown(result.obj)
                                }
                              >
                                <p>{result.obj.name}</p>
                              </li>
                ...
                productQueue.map((product) => {
                  return (
                    <tr role="row">
                      ...
                      <td role="cell">{categoryMap[product.category]}</td>
                      <td role="cell">{product.oldPrice}</td>
                      <td role="cell">{product.newPrice}</td>
                      <td role="cell">
                        <button
